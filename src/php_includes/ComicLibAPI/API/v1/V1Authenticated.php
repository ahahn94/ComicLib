...
/**
 * Class V1Authenticated
 * Implements functions to handle the authentication status of an API key.
 */
class V1Authenticated implements ComicLibAPIResource
{
    ...
    function GET()
    {
        ...
        if (empty($this->path)) {
            ...
            if ($this->apiAuthentication->getAuthenticatedUser() !== false){
                $responseCode = 200;
            } else {
                $responseCode = 401;
            }
